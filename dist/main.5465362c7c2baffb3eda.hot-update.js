"use strict";
self["webpackHotUpdatepet_game"]("main",{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n  --white: #fff;\n  --black: #111;\n  --html-bg: rgb(244, 244, 244);\n  --wrapper-bg: #fee6e3;\n}\n\n* {\n  font-family: \"Philosopher\", sans-serif;\n  box-sizing: border-box;\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  text-rendering: geometricPrecision;\n  outline: 0;\n  -moz-outline-style: none;\n  -webkit-tap-highlight-color: transparent;\n}\n\nbody,\nhtml {\n  background-color: var(--html-bg);\n  height: 100%;\n}\n\nh1 {\n  font-size: 2.5em;\n}\n\n.section-quote {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n}\n\n.wrapper {\n  background-color: var(--wrapper-bg);\n  border: 2px solid var(--black);\n  border-radius: 8px;\n  box-sizing: border-box;\n  color: var(--black);\n  max-width: 100%;\n  padding: 0 25px;\n  position: relative;\n}\n.wrapper:after {\n  background-color: var(--black);\n  border-radius: 8px;\n  content: \"\";\n  display: block;\n  height: 100%;\n  left: 0;\n  width: 100%;\n  position: absolute;\n  top: -2px;\n  transform: translate(8px, 8px);\n  transition: transform 0.2s ease-out;\n  z-index: -1;\n}\n\n.keyboard {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.quote-letters-count {\n  margin-bottom: 20px;\n}\n\n.badge {\n  padding: 4px 8px;\n  text-align: center;\n  border-radius: 5px;\n  margin-left: 4px;\n  color: var(--white);\n  background-color: var(--black);\n}\n\n.info-wrapper {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n\n.start-btn-wrapper {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.timer {\n  margin-top: 20px;\n}\n\nbutton {\n  background-color: var(--black);\n  border-radius: 4px;\n  border-style: none;\n  color: var(--white);\n  cursor: pointer;\n  font-size: 16px;\n  font-weight: 700;\n  max-width: none;\n  min-height: 44px;\n  min-width: 10px;\n  margin-bottom: 20px;\n  outline: none;\n  overflow: hidden;\n  padding: 9px 20px 8px;\n  position: relative;\n  text-align: center;\n  text-transform: none;\n  user-select: none;\n}\nbutton:hover, button:focus {\n  opacity: 0.75;\n}\n\n.opacity-on {\n  opacity: 1;\n  transition: opacity 1s ease-out;\n}\n\n.opacity-off {\n  opacity: 0;\n}", "",{"version":3,"sources":["webpack://./src/components/index.scss"],"names":[],"mappings":"AAAA;EACG,aAAA;EACA,aAAA;EACA,6BAAA;EACA,qBAAA;AACH;;AAEA;EACG,sCAAA;EACA,sBAAA;EACA,mCAAA;EACA,kCAAA;EACA,kCAAA;EACA,UAAA;EACA,wBAAA;EACA,wCAAA;AACH;;AAEA;;EAEG,gCAAA;EACA,YAAA;AACH;;AAEA;EACG,gBAAA;AACH;;AAEA;EACG,kBAAA;EACA,QAAA;EACA,SAAA;EACA,gCAAA;AACH;;AAEA;EACG,mCAAA;EACA,8BAAA;EACA,kBAAA;EACA,sBAAA;EACA,mBAAA;EACA,eAAA;EACA,eAAA;EACA,kBAAA;AACH;AACG;EACG,8BAAA;EACA,kBAAA;EACA,WAAA;EACA,cAAA;EACA,YAAA;EACA,OAAA;EACA,WAAA;EACA,kBAAA;EACA,SAAA;EACA,8BAAA;EACA,mCAAA;EACA,WAAA;AACN;;AAGA;EACG,aAAA;EACA,uBAAA;EACA,mBAAA;AAAH;;AAGA;EACG,mBAAA;AAAH;;AAGA;EACG,gBAAA;EACA,kBAAA;EACA,kBAAA;EACA,gBAAA;EACA,mBAAA;EACA,8BAAA;AAAH;;AAGA;EACG,aAAA;EACA,8BAAA;EACA,mBAAA;AAAH;;AAGA;EACG,aAAA;EACA,uBAAA;EACA,mBAAA;AAAH;;AAGA;EACG,gBAAA;AAAH;;AAGA;EACG,8BAAA;EACA,kBAAA;EACA,kBAAA;EACA,mBAAA;EACA,eAAA;EACA,eAAA;EACA,gBAAA;EACA,eAAA;EACA,gBAAA;EACA,eAAA;EACA,mBAAA;EACA,aAAA;EACA,gBAAA;EACA,qBAAA;EACA,kBAAA;EACA,kBAAA;EACA,oBAAA;EACA,iBAAA;AAAH;AACG;EAEG,aAAA;AAAN;;AAIA;EACG,UAAA;EACA,+BAAA;AADH;;AAIA;EACG,UAAA;AADH","sourcesContent":[":root {\n   --white: #fff;\n   --black: #111;\n   --html-bg: rgb(244, 244, 244);\n   --wrapper-bg: #fee6e3;\n}\n\n* {\n   font-family: \"Philosopher\", sans-serif;\n   box-sizing: border-box;\n   -webkit-font-smoothing: antialiased;\n   -moz-osx-font-smoothing: grayscale;\n   text-rendering: geometricPrecision;\n   outline: 0;\n   -moz-outline-style: none;\n   -webkit-tap-highlight-color: transparent;\n}\n\nbody,\nhtml {\n   background-color: var(--html-bg);\n   height: 100%;\n}\n\nh1 {\n   font-size: 2.5em;\n}\n\n.section-quote {\n   position: absolute;\n   top: 50%;\n   left: 50%;\n   transform: translate(-50%, -50%);\n}\n\n.wrapper {\n   background-color: var(--wrapper-bg);\n   border: 2px solid var(--black);\n   border-radius: 8px;\n   box-sizing: border-box;\n   color: var(--black);\n   max-width: 100%;\n   padding: 0 25px;\n   position: relative;\n\n   &:after {\n      background-color: var(--black);\n      border-radius: 8px;\n      content: \"\";\n      display: block;\n      height: 100%;\n      left: 0;\n      width: 100%;\n      position: absolute;\n      top: -2px;\n      transform: translate(8px, 8px);\n      transition: transform 0.2s ease-out;\n      z-index: -1;\n   }\n}\n\n.keyboard {\n   display: flex;\n   justify-content: center;\n   align-items: center;\n}\n\n.quote-letters-count {\n   margin-bottom: 20px;\n}\n\n.badge {\n   padding: 4px 8px;\n   text-align: center;\n   border-radius: 5px;\n   margin-left: 4px;\n   color: var(--white);\n   background-color: var(--black);\n}\n\n.info-wrapper {\n   display: flex;\n   justify-content: space-between;\n   align-items: center;\n}\n\n.start-btn-wrapper {\n   display: flex;\n   justify-content: center;\n   align-items: center;\n}\n\n.timer {\n   margin-top: 20px;\n}\n\nbutton {\n   background-color: var(--black);\n   border-radius: 4px;\n   border-style: none;\n   color: var(--white);\n   cursor: pointer;\n   font-size: 16px;\n   font-weight: 700;\n   max-width: none;\n   min-height: 44px;\n   min-width: 10px;\n   margin-bottom: 20px;\n   outline: none;\n   overflow: hidden;\n   padding: 9px 20px 8px;\n   position: relative;\n   text-align: center;\n   text-transform: none;\n   user-select: none;\n   &:hover,\n   &:focus {\n      opacity: 0.75;\n   }\n}\n\n.opacity-on {\n   opacity: 1;\n   transition: opacity 1s ease-out;\n}\n\n.opacity-off {\n   opacity: 0;\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _components_index_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/index.scss */ "./src/components/index.scss");
...
root.render(react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_HelloWorld__WEBPACK_IMPORTED_MODULE_2__["default"], null));
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b3d8e07b05d35ae86035")
/******/ })();
/******/ 
...
//# sourceMappingURL=main.5465362c7c2baffb3eda.hot-update.js.map